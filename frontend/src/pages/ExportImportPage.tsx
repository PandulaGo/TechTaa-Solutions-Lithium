  ...
  return (
    <div className="space-y-4">
      ...
      <details className="bg-gray-900 border border-gray-800 rounded-lg p-4">
        <summary className="text-sm font-semibold text-gray-300 cursor-pointer">Sample Import JSON Format</summary>
        <p className="text-xs text-gray-500 mt-2 mb-3">Use this structure to build your own import file. Remove any fields you don't need.</p>
        <pre className="bg-gray-950 border border-gray-700 rounded p-4 text-xs text-gray-300 overflow-auto max-h-[600px] whitespace-pre leading-relaxed">
{`{
  "endpoints": [
    {
      "name": "Get Users",
